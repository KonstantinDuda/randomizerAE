...
// Friend Foe Cards
  ...
  Future<List<AECard>> _getCardsFromDB() async {
    List<AECard> list = await db.getFriendFoeCards();
    return list;
  }
  ...
  createStacks() {
    checkCards();
    CardsStack dalanaTheHealer = CardsStack.empty();
    CardsStack theScavenger = CardsStack.empty();
    CardsStack adelheimTheBlacksmith = CardsStack.empty();
    CardsStack myrnaTheScholar = CardsStack.empty();
    CardsStack fawnTheAlchemist = CardsStack.empty();
    CardsStack theCorrosion = CardsStack.empty();
    CardsStack theSwarm = CardsStack.empty();
    CardsStack theCultist = CardsStack.empty();
  }
}
